...
Entitlement is an object that describes a user's entitlements to read or write data in your CRM. More information about entitlements can be found in the [Entitlements](/entitlements.html) page.
